...
class DefaultEnviromentConfig {
    ...
    httpsPort = 3001;
    envName = 'defaut';
    hashingSecret = 'blabla';   // very important to define on proction mode. public internet is a security hell.
    tokenTimeout = 1000*60*60;  // 1 hour defined in miliseconds
    stripe_api_key = 'sk_test_51IFmF7CNn1q1Zb719gcEjjPFe49n8fvl90N7otdaUtxVrWPhqpVVEkotnLwSqGjB2PekQhUcq0MfhBXdVGCyaUQt002JHyHLLQ';
    mailgun = {
